...
export function CompositeRangeSlider({
  ...
  return (
    <div className="w-full space-y-2">
      ...
      >
        <Slider.Track className="relative h-1.5 grow rounded-full bg-atlas-mid">
          <Slider.Range className="absolute h-full rounded-full bg-gradient-to-r from-atlas-vivid to-atlas-bloom" />
        </Slider.Track>
        <Slider.Thumb
